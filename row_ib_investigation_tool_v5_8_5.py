"""
MFI Investigation Tool  v5.8.5  |  ROW IB
==========================================
ROW IB  |  Amazon
Developed by Mukesh
...
class MFIToolApp:
    def __init__(self):
        ...
        self.root.title("MFI Investigation Tool  v5.8.5  |  ROW IB")
        try:
            ...
            if all_pending:
                ...
                def on_pending_result(res):
                    if res['action'] == 'next_asin':
                        ...
                        m.get('processed', set()).add(inv_match.get('mtc_inv', ''))
    ...
    def _show_pending_invoices_from_dialog(self):
        ...
        def on_pending_result(res):
            if res['action'] == 'investigate':
                inv_match = res['match']
                self.curr_m.get('processed', set()).add(inv_match.get('mtc_inv', ''))
                self.root.after(0,
                    lambda inv=inv_match: self._show_dlg([inv]))
