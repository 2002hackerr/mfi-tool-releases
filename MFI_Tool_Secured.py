"""
MFI Investigation Tool  v5.9.0  |  ROW IB (Secured Edition)
==========================================
ROW IB  |  Amazon
Developed by Mukesh
...
import os, re, threading, urllib.request, sys
...
class MFIToolApp:
    def __init__(self):
        ...
        self.root.title("MFI Investigation Tool  v5.9.0  |  ROW IB (Secured Edition)")
        try:
    ...
    def _build_ui(self):
        ...
        tk.Label(t, text="v5.9.0  |  ROW IB  [SECURED]",
                 fg="#8888aa", bg="#16213e",
