"""
MFI Investigation Tool  v5.2.0  |  ROW IB
==========================================
ROW IB  |  Amazon
Developed by Mukesh
...
class HeaderCorrectionDialog(tk.Toplevel):
    ...
    def __init__(self, parent, corrections, mapping, df_columns, callback):
        ...
        self.title("Column Header Mismatch Detected — v5.2.0")
...
class PreviewPanel(tk.Toplevel):
    COLS      = ['Barcode', 'Inv no', 'SID', 'PO', 'ASIN', 'Inv Qty',
                 'Rec Qty', 'Mtc Qty', 'Mtc Inv', 'Remarks', 'Date']
...
def write_excel(all_blocks, path):
    ...
    headers = ["Barcode", "Inv no", "SID", "PO", "ASIN",
               "Inv Qty", "Rec Qty", "Mtc Qty", "Mtc Inv", "Remarks", "Date"]
...
class MFIToolApp:
    def __init__(self):
        ...
        self.root.title("MFI Investigation Tool  v5.2.0  |  ROW IB")
        try:
    ...
    def _man_step(self):
        ...
        if should_stop:
            ...
            # Stack fully drained → finalize block
