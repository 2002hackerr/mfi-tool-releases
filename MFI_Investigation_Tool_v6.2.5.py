"""
MFI Investigation Tool  v6.2.5  |  ROW IB (Secured Edition)
==========================================
ROW IB  |  Amazon
Developed by Mukesh
...
class MFIToolApp:
    def __init__(self):
        ...
        self.root = tk.Tk(); self.root.title("MFI Investigation Tool  v6.2.5  |  ROW IB (Secured Edition)")
    ...
    def _build_ui(self):
        ...
        tk.Label(t, text="v6.2.5 | ROW IB (Secured Edition)", fg="#f0a500", bg="#16213e", font=("Segoe UI", 10, "bold")).pack(side="right", padx=10)
        ...
        try:
            ...
            if self.mode_var.get() == "auto":
                ...
                for i, (_, r) in enumerate(df_c.iterrows()):
                    ...
                    # v6.2.5: Reset ASIN isolation state
    ...
    def _next_man(self, force_next=False):
        ...
        # v6.2.5: Reset isolation per ASIN when moving to the next item
        self.engine.asin_pending_matches = []
        self.global_processed.clear()
    ...
    def _man_step(self):
        ...
        for mt in matches:
            ...
            # v6.2.5: Deduplicate identical invoice matches from the manual dialog entirely.
